...
* When it comes to the turn of player 1, highlight the card of player 1 in the game. When it comes to the turn of player 2, highlight the card of player 2 in the game. The highlight color should be different depending on what kind of turn it is. If it's attack turn, highlight the card in gold. If it's defensive turn, highlight the card in blue.
